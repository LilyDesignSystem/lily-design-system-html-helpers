...
if (
  ...
  !customElements.get("theme-picker")
) {
...
describe("<theme-picker> — matchSystemTheme (mirrors matchNavigatorLanguage)", () => {
...
describe("<theme-picker> — detect-from-system attribute", () => {
...
describe("<theme-picker> — keyboard contract (APG listbox, §7.14–§7.18)", () => {
...
describe("<theme-picker> — custom rendering by subclass (§7.19)", () => {
...
describe("<theme-picker> — accessibility hardening (§7.21–§7.24)", () => {
