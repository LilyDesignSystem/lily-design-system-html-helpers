...
<ul class="locale-select-list" id="locale-select-1-list" role="listbox"
    ...
    aria-activedescendant="locale-select-1-option-2">
    <li id="locale-select-1-option-0" role="option" aria-selected="true" lang="en">English</li>
    <li id="locale-select-1-option-1" role="option" aria-selected="false" lang="fr">Français</li>
    <li id="locale-select-1-option-2" role="option" aria-selected="false" data-active lang="ar">العربية</li>
</ul>
```
...
```html
<li class="locale-select-option" role="option" aria-selected="true" lang="en">English</li>
<li class="locale-select-option" role="option" aria-selected="false" lang="fr">Français</li>
<li class="locale-select-option" role="option" aria-selected="false" lang="ar">العربية</li>
```
...
monochrome and consistent with theme-select's ◑ (U+25D1 is not an
...
text` on `.locale-select-icon` forces it where supported.
...
- **Respect `hidden`.** The element toggles the `hidden` attribute on
  the `<ul>`. Any rule that sets `display` on `.locale-select-list`
  will defeat it; guard with `.locale-select-list[hidden] { display:
  none; }`.
