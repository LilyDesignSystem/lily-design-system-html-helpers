...
2. Build a copy of the theme-select module at `/dist/theme-select.js`.
...
build:  Eleventy reads _data/theme.js → renders layout with theme.defaultTheme
        ...
        <theme-select value="light"> rendered with the resolved attribute
visit:  browser parses HTML, applies <link>, loads /dist/theme-select.js
