...
All notable changes to `@lilydesignsystem/html-share-picker` are
...
relative to `lily-design-system-html-share-picker`'s last published version (`0.2.0`);
...
First release under the name `@lilydesignsystem/html-share-picker`.
...
canonical Svelte helper `@lilydesignsystem/svelte-share-picker` to a
