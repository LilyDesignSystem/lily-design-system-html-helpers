...
export class LocalePicker extends HTMLElement {
    ...
    #render(): void {
        ...
        fieldset.className = `locale-picker ${extraClass}`.trim();
        ...
        for (const locale of this.#locales) {
            ...
            label.className = "locale-picker-option";
            label.setAttribute("lang", this.#tagFor(locale));

            const input = document.createElement("input");
            input.type = "radio";
            input.name = radioName;
            input.value = locale;
            input.checked = current === locale;
            ...
            span.textContent = this.#labelFor(locale);
